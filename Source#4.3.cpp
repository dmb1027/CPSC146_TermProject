...
bool Unique_Question(int questionNumber, int inputVal) {
	...
	while (!done) {
		...
		if (flag == false) {
			...
			while (m < inputVal) {
				...
				questionNumber = random_x;
				Unique_Question(questionNumber, inputVal);
				string Q;
				if (Unique_Question(questionNumber, inputVal) == true) {
